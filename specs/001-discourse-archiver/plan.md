...
**Primary Dependencies**: `requests` (HTTP), `html2text` (HTML->Markdown); `pytest`, `ruff` (dev)
...
| III. Minimal Dependencies | PASS | 2 runtime deps (requests, html2text); stdlib covers rest (tomllib, argparse, pathlib, json, signal) |
